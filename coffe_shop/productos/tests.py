...
class ListProductsViewsTests(TestCase):
    ...
    def test_show_return_200(self):
        ...
        response = self.client.get(url) # --> el metodo self.client permite crear un cliente http con el
        ...
        self.assertEqual(response.context['products'].count(), 0) # -> comparamos si el contador de productos es = 0
